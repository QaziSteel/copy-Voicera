        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              >
                <span className={showHourDropdown || customHour !== "00 hr" ? "text-black" : "text-muted-foreground"}>{customHour}</span>
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
            ...
            <div className="relative">
              ...
              >
                <span className={showMinuteDropdown || customMinute !== "00 min" ? "text-black" : "text-muted-foreground"}>{customMinute}</span>
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
