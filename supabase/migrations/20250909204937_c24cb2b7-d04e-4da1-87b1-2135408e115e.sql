-- First, clean up invalid phone_number_id references
UPDATE call_logs 
SET phone_number_id = NULL 
WHERE phone_number_id IS NOT NULL 
AND phone_number_id NOT IN (SELECT id FROM phone_numbers);

-- Now update call_logs to set correct phone_number_id by matching phone_number
UPDATE call_logs 
