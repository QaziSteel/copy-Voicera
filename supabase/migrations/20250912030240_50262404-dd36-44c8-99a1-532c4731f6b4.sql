-- Step 1: Insert new phone_numbers records with external IDs (without deleting old ones yet)
...
-- Step 3: Delete the old phone_number records that have been replaced
